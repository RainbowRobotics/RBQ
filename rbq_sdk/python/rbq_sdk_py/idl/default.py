...
"""
" rbq_api.msg.dds_ dafault
"""
def rbq_api_msg_dds__RequestIdentity_():
    return RequestIdentity_(0, 0)

def rbq_api_msg_dds__RequestLease_():
    return RequestLease_(0, unitree_hg_msg_dds__IMUState_(), [], )

def rbq_api_msg_dds__RequestPolicy_():
    return RequestPolicy_(0, False)

def rbq_api_msg_dds__RequestHeader_():
    return RequestHeader_(rbq_api_msg_dds__RequestIdentity_(), rbq_api_msg_dds__RequestLease_(),
            rbq_api_msg_dds__RequestPolicy_())

def rbq_api_msg_dds__Request_():
    return Request_(rbq_api_msg_dds__RequestHeader_(), "", [])

def rbq_api_msg_dds__ResponseStatus_():
    return ResponseStatus_(0)

def rbq_api_msg_dds__ResponseHeader_():
    return ResponseHeader_(rbq_api_msg_dds__RequestIdentity_(), rbq_api_msg_dds__ResponseStatus_())

def rbq_api_msg_dds__Response_():
    return Response_(rbq_api_msg_dds__ResponseHeader_(), "", [], 0, 0, [0, 0])
