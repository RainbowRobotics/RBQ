...
public:
    ...
    struct IMU {
         ...
         * @ingroup IMUSensorAPI
         */
        int getRPY(Eigen::Vector<float, 3> &out_rpy_);
         ...
         *
         * @param out_gyro_ Reference to an Eigen::Vector<float, 3> to store angular velocity.
         * @return Returns 1 on success.
         *
         * @ingroup IMUSensorAPI
         */
        int getGyro(Eigen::Vector<float, 3> &out_gyro_);
         ...
         *
         * @param out_acc_ Reference to an Eigen::Vector<float, 3> to store acceleration data.
         * @return Returns 1 on success.
         *
         * @ingroup IMUSensorAPI
         */
        int getAcc(Eigen::Vector<float, 3> &out_acc_);
